 ...
 * @var \App\Model\Entity\PackageType[]|\Cake\Collection\CollectionInterface $packageTypes
 */
?>
...
<div class="packageTypes index large-9 medium-8 columns content">
    <h3><?= __('Package Types') ?></h3>
