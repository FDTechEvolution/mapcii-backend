        ...
        <div id="package-form" class="card m-b-20 card-body">
            ...
            <?= $this->Form->create($package, ['id' => 'package']) ?>
                <div class="form-group row ">
                    <div class="col-lg-6 ">
                        <h2 class="prompt-400 "><i class="ti-package"></i> เพิ่มแพ็คเกจประกาศ AD</h2>
                    </div>
                    ...
                    <div class="col-md-10 form-group mt-2 border-top">
                        ...
                        <ul class="pl-0" style="border-bottom: 1px solid #ddd">
                            ...
                            <?php foreach ($durations as $key => $duration): ?>
                                ...
                                <input type="hidden" name="size[]" value="<?= h($sizes[0]->id) ?>">
                            <?php endforeach; ?>
                        </ul>
                        ...
                        <ul class="pl-0" style="border-bottom: 1px solid #ddd">
                            ...
                            <?php foreach ($durations as $key => $duration): ?>
                                ...
                                <input type="hidden" name="package_duration_id[]" value="<?=$duration->id?>">
                                <input type="hidden" name="size[]" value="<?= h($sizes[1]->id) ?>">
                            <?php endforeach; ?>
                        </ul>
                        ...
                        <ul class="pl-0" style="border-bottom: 1px solid #ddd">
                            ...
                            <?php foreach ($durations as $key => $duration): ?>
                                ...
                                <input type="hidden" name="package_duration_id[]" value="<?=$duration->id?>">
                                <input type="hidden" name="size[]" value="<?= h($sizes[2]->id) ?>">
                            <?php endforeach; ?>
                        </ul>
                    </div>
                </div>
