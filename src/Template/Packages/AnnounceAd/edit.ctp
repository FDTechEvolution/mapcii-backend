        ...
        <div id="package-form" class="card m-b-20 card-body">
            ...
            <?= $this->Form->create($package, ['id' => 'package']) ?>
                <div class="form-group row ">
                    <div class="col-lg-6 ">
                        <h2 class="prompt-400 "><i class="ti-package"></i> แก้ไขแพ็คเกจประกาศ AD</h2>
                    </div>
                ...
                <div class="row justify-content-md-center" id="customer_box" >
                    ...
                    <div class="col-md-10 form-group mt-2 border-top">
                        ...
                        <ul class="pl-0" style="border-bottom: 1px solid #ddd">
                            <strong>Size : <?= h($sizes[0]->name) ?></strong>
                            <?php foreach ($package->package_lines as $key => $packageline): ?>
                                <?php if($packageline->size->name == 'S'): ?>
                                    <li class="row justify-content-md-center mt-3 mb-3">
                                        ...
                                        <div class="col-md-2">
                                            <input type="number" name="procredit[]" id="procredit" class="form-control" style="border-color: #00b19d;" value="<?= $packageline->procredit ?>">
                                        </div>
                                        <div class="col-md-2">
                                            <input type="number" name="proprice[]" id="proprice" class="form-control" style="border-color: #00b19d;" value="<?= $packageline->proprice ?>">
                                        </div>
                                    </li>
                        ...
                        <ul class="pl-0" style="border-bottom: 1px solid #ddd">
                            <strong>Size : <?= h($sizes[1]->name) ?></strong>
                            <?php foreach ($package->package_lines as $key => $packageline): ?>
                                <?php if($packageline->size->name == 'M'): ?>
                                    <li class="row justify-content-md-center mt-3 mb-3">
                                        <div class="col-md-2 pt-1">
                                            <strong><?= h($packageline->package_duration->duration_name); ?> ( <?= h($packageline->package_duration->duration_exp) ?> วัน )</strong>
                                        </div>
                        ...
                        <ul class="pl-0">
                            <strong>Size : <?= h($sizes[2]->name) ?></strong>
                            <?php foreach ($package->package_lines as $key => $packageline): ?>
                                <?php if($packageline->size->name == 'L'): ?>
                                    <li class="row justify-content-md-center mt-3 mb-3">
                                        <div class="col-md-2 pt-1">
                                            <strong><?= h($packageline->package_duration->duration_name); ?> ( <?= h($packageline->package_duration->duration_exp) ?> วัน )</strong>
                                        </div>
