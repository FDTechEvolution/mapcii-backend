        ...
        <div class="card m-b-20">
            <div class="row p-20 pb-10">
                <div class="col-md-12" style="display: flex;">
                    <h3 class="m-t-0 m-b-0">แพ็คเกจ Banner B</h3>
                    <?= $this->Html->link('<i class=" fa fa-pencil"></i> แก้ไข', ['action' => 'banner-b-edit'], ['class' => 'btn btn-secondary waves-effect', 'style' => 'margin-left: 20px; padding: 5px 10px;', 'escape' => false]) ?>
                </div>
            </div>
