...
<div class="row">
    <div class="col-md-12">
        <div class="card-box">
            <?= $this->Form->create($article, ['class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea id="short_content" name="short_content" class="form-control" rows="5"><?= $article->short_content ?></textarea>
                    </div>

                </div>
                <div class="col-md-6">
                    <?php if ($article->image_id != null && $article->image_id != '') { ?>
            ...
            <div class="form-group">
                <textarea id="elm1" name="content"><?= $article->content ?></textarea>
            </div>
            <div class="form-group">
                <?= BT_SAVE ?>
            </div>
