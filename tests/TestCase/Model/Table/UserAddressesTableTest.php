...
class UserAddressesTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('UserAddresses') ? [] : ['className' => UserAddressesTable::class];
        $this->UserAddresses = TableRegistry::getTableLocator()->get('UserAddresses', $config);
    }
