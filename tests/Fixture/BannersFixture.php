...
class BannersFixture extends TestFixture
{
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 'a9cad516-d88a-4a8d-bc03-30f0f4cb67ff',
                'type' => 'Lorem ipsum dolor sit amet',
                'user_id' => '98a0793e-d365-40ef-879a-fe0fe4e01bb6',
                'image_id' => 'f6a8b71e-fadf-49f2-b7a9-37d289088a68',
                'description' => 'Lorem ipsum dolor sit amet',
                'position' => 'Lorem ipsum dolor sit amet',
                'isactive' => 'Lorem ipsum dolor sit amet',
                'isapproved' => 'Lorem ipsum dolor sit amet',
                'created' => '2018-10-30 06:38:08',
                'createdby' => 'dafca467-4ada-48d5-a20d-7dddda82cc13'
            ],
        ];
        parent::init();
    }
